  ...
  questions: [
    {
      ...
      questionType: "text",
      questionPic: Bag, // if you need to display Picture in Question
      answerSelectionType: "single",
    ...
    },
    {
      ...
      questionType: "text",
      questionPic: Apple, // if you need to display Picture in Question
      answerSelectionType: "single",
    ...
    },
    {
      question: "Identify the Given Object",
      questionType: "text",
      questionPic: Spoon, // if you need to display Picture in Question
      answerSelectionType: "single",
    ...
    },
    {
      ...
      questionType: "text",
      questionPic: Bird, // if you need to display Picture in Question
      answerSelectionType: "single",
...

    {
      ...
      questionType: "text",
      questionPic: Three, // if you need to display Picture in Question
      answerSelectionType: "single",
    ...
    //   question: "Identify the Given Animal",
    //   questionType: "text",
    //   questionPic: Duck, // if you need to display Picture in Question
    //   answerSelectionType: "single",
